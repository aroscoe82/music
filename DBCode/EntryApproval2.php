...
echo "<p id=\"band-bio\">" . substr(nl2br($row['Bio']), 0, 200) . "... <a id=\"band-bio-link\" href=\"http://phlmusicfest.com/bio-page/?EntryID=" . $row['UserID'] . "\">More Info</a></p>";
                ...
                if($able2VoteNow == true){
                     ...
                     //echo "<p>Display Number of Votes Here</p>";
                }
                echo "</div>";
                echo "</div>";
           }
