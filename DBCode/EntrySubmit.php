...
// Strip phone number entry to only numbers
$_SESSION['Phone'] = preg_replace("/[^0-9A-Za-z]/", "", $_SESSION['Phone']);
...
//echo "Connected to DB";
	...
	$extension = end(explode(".", $_FILES["file"]["name"]));
     ...
     if (mysqli_query($con,$sql)){
          ...
          $sql = "INSERT INTO MailingList (UserID, Name, Address1, Address2, City, State, ZipCode, Phone) VALUES (\"" . $EntryID . "\",\"" . $_SESSION['EntryName']  . "\",\"" . $_SESSION['Address1'] . "\",\"" . $_SESSION['Address2'] . "\",\"" . $_SESSION['City']  . "\",\"" . $_SESSION['State']  . "\",\"" . $_SESSION['ZipCode']  . "\",\"" . $_SESSION['Phone']  . "\")";;

          if (mysqli_query($con,$sql)){
          if($fileUploaded == 1){
               $tempName = ereg_replace("[^A-Za-z0-9]", "", $_SESSION['EntryName']);
               $fileName = $EntryID . "-" . $tempName;
